...
plt.tight_layout()
plt.savefig(FIGURES_DIR / "pipeline_architecture_diagram.png", dpi=300, bbox_inches="tight")
plt.close()
...
# Labels for creators and prominent brands
labels = {}
for n in G.nodes():
...
plt.tight_layout()
plt.savefig(FIGURES_DIR / "network_topology_overview.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig(FIGURES_DIR / "centrality_rankings.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig(FIGURES_DIR / "diffusion_cascade_curves.png", dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(FIGURES_DIR / "extraction_fidelity_benchmark.png", dpi=300, bbox_inches='tight')
plt.close()
